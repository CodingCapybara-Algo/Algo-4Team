...
public class PGS_퍼즐조각채우기 {
    ...
    static int findBlock(List<List<int[]>> board, List<List<int[]>> table){
        int size = 0;
    ...
    static boolean isRotate(List<int[]> board, List<int[]> table){
    ...
    static void bfs(int currentX, int currentY, boolean[][] visited, int[][] graph,
